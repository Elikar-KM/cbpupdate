-- Simplified SQL script to create notification tables
-- Execute this via: php artisan tinker < create_notification_tables.php
...
echo "Table notification_templates created\n";
...
echo "Table notification_campaigns created\n";
...
echo "Table notification_logs created\n";
...
echo "All notification tables created successfully!\n";
